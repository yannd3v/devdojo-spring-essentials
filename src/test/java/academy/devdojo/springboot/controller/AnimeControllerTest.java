...
import academy.devdojo.springboot.util.AnimeDtoCreator;
...
class AnimeControllerTest {
    ...
    @Test
    @DisplayName("listAll return list of anime when sucessful")
    ...
    @Test
    @DisplayName("findByName return list of anime when sucessful")
    ...
    void replace_UpdatesAnime_WhenSucessful(){
        Assertions.assertThatCode(() ->animeController.replace(AnimeDtoCreator.updateAnimeDTO()))
                .doesNotThrowAnyException();

        ResponseEntity<Void> entity = animeController.replace(AnimeDtoCreator.updateAnimeDTO());
